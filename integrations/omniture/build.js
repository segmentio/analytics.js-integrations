  ...
  describe('before loading', function() {
    ...
    describe('#initialize', function() {
      ...
      it('should set new fields on this.options based on sOptions', function() {
        ...
        analytics.equal(omniture.options.linkDownloadFileTypes, 'exe,zip,wav,mp3,mov,mpg,avi,wmv,pdf,doc,docx,xls,xlsx,ppt,pptx');
...
}, {"analytics.js-core":5,"analytics.js-integration":6,"clear-env":7,"analytics.js-integration-tester":8,"../lib/":9}],
...
}, {"emitter":12,"facade":13,"after":14,"bind-all":15,"callback":16,"clone":17,"./cookie":18,"debug":19,"defaults":20,"each":21,"foldl":22,"./group":23,"is":24,"is-meta":25,"object":26,"./memory":27,"./normalize":28,"event":29,"./pageDefaults":30,"pick":31,"prevent":32,"querystring":33,"./store":34,"./user":35}],
...
}, {"./facade":37,"./alias":38,"./group":39,"./identify":40,"./track":41,"./page":42,"./screen":43}],
...
}, {"isodate-traverse":44,"./is-enabled":45,"./utils":46,"./address":47,"obj-case":48,"new-date":49}],
...
}, {"./facade":37,"is-email":59,"new-date":49,"./utils":46,"obj-case":48,"trim":60}],
...
}, {"./utils":46,"./facade":37,"./identify":40,"is-email":59,"obj-case":48}],
...
}, {"bind-all":15,"clone":17,"cookie":63,"debug":19,"defaults":20,"json":64,"top-domain":65}],
...
}, {"clone":17,"./cookie":18,"debug":19,"defaults":20,"extend":75,"./memory":27,"./store":34,"isodate-traverse":44}],
...
}, {"debug":19,"defaults":20,"each":21,"includes":77,"is":24,"component/map":78}],
...
}, {"./entity":73,"bind-all":15,"./cookie":18,"debug":19,"inherit":74,"cookie":63,"uuid":84}],
...
}, {"bind":61,"clone":17,"debug":85,"defaults":20,"extend":86,"slug":87,"./protos":88,"./statics":89}],
...
}, {"emitter":12,"after":14,"each":92,"analytics-events":93,"fmt":94,"foldl":22,"load-iframe":95,"load-script":96,"to-no-case":97,"next-tick":62,"every":98,"is":99}],
...
}, {"clear-ajax":103,"clear-timeouts":104,"clear-intervals":105,"clear-listeners":106,"clear-globals":107,"clear-images":108,"clear-scripts":109,"clear-cookies":110}],
...
}, {"indexof":36,"assert":112,"domify":113,"stub":114,"each":92,"keys":115,"fmt":94,"spy":116,"is":50}],
...
Omniture
  ...
  .tag('1', '<script src="//cdn.segment.io/integrations/omniture/H.26.2/omniture.min.js">')
  .tag('2', '<script src="http://localhost:1738/appmeasurement.min.js">');
...
}, {"analytics.js-integration":6,"ndhoule/extend":122,"each":123,"./v1":124,"./v2":125}],
...
v2Methods.page = function(page) {
  ...
  if (userId && !this.options.includeTimestamp) window.s.visitorID = userId;
...
function updateCommonVariables(facade, options) {
  ...
  if (facade.type() === 'track') update('pageName', properties.pageName || options.pageName || facade.proxy('context.page.title'));
}
  ...
  describe('V1', function() {
    ...
    describe('#track', function() {
      ...
      it('tracks product information', function() {
        ...
        analytics.equal(window.s.products, 'Dental Aids; Wooden Teeth; 32; 17.76');
        analytics.deepEqual(window.s.events, window.s.linkTrackEvents);
...
}, {"analytics.js-core":5,"to-iso-string":127,"clear-env":7,"analytics.js-integration-tester":8,"../lib/":9}],
...
}, {"analytics.js-core":5,"to-iso-string":127,"clear-env":7,"analytics.js-integration-tester":8,"../lib/":9}]}, {}, {"1":""})
